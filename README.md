...
Supplier Profile описывает структуру файла поставщика: ожидаемые форматы и листы,
технические соответствия колонок и декларативные правила проверки. Профили и их
версии не выполняют detection, matching, нормализацию или расчёт заказа.
